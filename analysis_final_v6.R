...
# 保存为TIFF
tiff("/workspace/forest_plot_final_v6.tiff", width = 32, height = 16, units = "in", res = 300, compression = "lzw")
grid.draw(final_plot)
dev.off()

png("/workspace/forest_plot_final_v6.png", width = 3200, height = 1600, res = 150)
grid.draw(final_plot)
dev.off()

cat("\n图片已保存:\n")
cat("- /workspace/forest_plot_final_v6.tiff (300 dpi, LZW压缩)\n")
cat("- /workspace/forest_plot_final_v6.png (预览)\n")
...
fwrite(result_table, "/workspace/rr_results_final_v6.csv")
cat("结果表格已保存到 /workspace/rr_results_final_v6.csv\n")
